...
vector<int> nextSmaller(vector<int>&input)
{
    ...
    for(int i=input.size()-1;i>=0;i--)
    {
        ...
        //apka answer stack me
        //kyonki indexes le rhe hain to ho skta hai -1 bhi ho galti se access na kr paayein is liye check kr rhe hain ki top -1 nhi hai
        while(s.top()!=-1 && input[s.top()]>=curr)
        {
            s.pop();
        }
...
cout<<"Ans is : "<<getRactangularAreaHistogram(v)<<"\n";
